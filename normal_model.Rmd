...
\qquad set $\tau_0^2 = \frac{\sigma^2}{\kappa_0}$, $\mu_n = \frac{\kappa_0}{\kappa_0 + n} \mu_0 + \frac{n}{\kappa_0 + n} \bar{y}$ and $\tau_n^2 = \frac{\sigma^2}{\kappa_0 + n} = \frac{\sigma^2}{\kappa_n}$ ($\kappa_n = \kappa_0 + n$)
...
s2_0 <- 0.01 ; nu_0 <- 1
# theta|sigma^2 ~ dnorm(mu_0, sigma^2/k_0)
mu_0 <- 1.9 ; k_0 <- 1
